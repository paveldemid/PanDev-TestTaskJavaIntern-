...
/**
 * Класс Category представляет собой сущность категории в иерархической структуре.
 * Каждая категория может иметь подкатегории и родительскую категорию.
 *
 * Класс использует аннотации JPA для работы с базой данных и поддерживает
 * операции добавления, удаления и управления подкатегориями.
 */
